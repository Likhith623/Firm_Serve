    ...
    <div className="relative">
      <div className="flex justify-between items-center py-4 px-4 md:px-8">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <Link href="/client/cases" className="hover:text-primary">
            Case
          </Link>
          <Link href="/client/appointment" className="hover:text-primary">
            Appointment
          </Link>
          <Link href="/client/bills_payment" className="hover:text-primary">
            Bills & Payment
          </Link>
